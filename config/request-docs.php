...
return [
    // changes doc title
    'title' => 'Sport Standings API - Documentation',
    'enabled' => true,
    ...
    */
    ...
    'open_api' => [
        'title' => 'Sport Standings API',
        'description' => 'API per recopilar resultats i classificacions esportives. Font de dades: openfootball/football.json',
